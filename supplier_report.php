...
$suppliers = [];
$sql = "SELECT sup_id, sup_name, tel, address FROM Supplier ORDER BY sup_id ASC";
...
<head>
    ...
    <title>ລາຍງານຂໍ້ມູນຜູ້ສະໜອງ</title>
...
<div class="receipt-container">
    ...
    <h2 class="receipt-title">ໃບລາຍງານຂໍ້ມູນຜູ້ສະໜອງ<br>Supplier Data Report Receipt</h2>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-left"><?php echo htmlspecialchars($supplier['sup_name']); ?></td>
                    <td><?php echo htmlspecialchars($supplier['tel']); ?></td>
                    <td class="text-left"><?php echo htmlspecialchars($supplier['address']); ?></td>
                </tr>
            <?php 
                endforeach;
            else: 
            ?>
                <tr>
                    <td colspan="4">ບໍ່ມີຂໍ້ມູນຜູ້ສະໜອງ.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
